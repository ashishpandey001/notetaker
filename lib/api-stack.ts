...
export class ApiStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ApiStackProps) {
    ...
    const listNotesFn = new cdk.aws_lambda_nodejs.NodejsFunction(
      this,
      "ListNotesFn",
      {
    ...
    const getNoteFn = new cdk.aws_lambda_nodejs.NodejsFunction(
      this,
      "GetNoteFn",
      {
    ...
    const getNoteIntegration =
      new cdk.aws_apigatewayv2_integrations.HttpLambdaIntegration(
        "GetNoteIntegration",
        getNoteFn,
      );

    const createNoteFn = new cdk.aws_lambda_nodejs.NodejsFunction(
      this,
      "CreateNoteFn",
      {
    ...
    const updateNoteFn = new cdk.aws_lambda_nodejs.NodejsFunction(
      this,
      "UpdateNoteFn",
      {
    ...
    const deleteNoteFn = new cdk.aws_lambda_nodejs.NodejsFunction(
      this,
      "DeleteNoteFn",
      {
